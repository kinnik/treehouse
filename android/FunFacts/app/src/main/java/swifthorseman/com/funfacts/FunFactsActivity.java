    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View.OnClickListener onClickListener = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final int randomColour = ColourWheel.getColour();
                relLayout.setBackgroundColor(randomColour);
                showFactButton.setTextColor(randomColour);
            }
        };
        showFactButton.setOnClickListener(onClickListener);

//        Toast.makeText(this, "Tinky winky", Toast.LENGTH_LONG).show();
        Log.d(TAG, "Oh oh");
    }
